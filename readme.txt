...
fixed: click on menu item having submenu
...
fixed: frontend styles in tablet mode
fixed: escaping of custom JS and integration parameters (PRO)
fixed: update notifications in child theme installed (PRO)
...
fixed: homepage top posts styles and post tabs styles
fixed: gallery page mobile styles (PRO)
...
fixed: homepage featured post styling if it has no image

=1.1.17=
fixed: header parallax image height after resize
fixed: slider description font size on phone
change: recommended plugins list updated

=1.1.16=
new: google fonts
fixed: some hardcoded font styles on front-end removed
fixed: duplicate excerpt in homepage content posts (free)
